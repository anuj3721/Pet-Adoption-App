...
class ManageCatPostsScreen extends StatefulWidget {
  @override
  _ManageCatPostsState createState() => new _ManageCatPostsState();
}

class _ManageCatPostsState extends State<ManageCatPostsScreen> {
  FirebaseAuth _auth;
